<div class="inner-content">
    ...
    <div class="feature-container">
        <div class="feature-group">
            ...
            <div class="ha_item_feature" v-for="(feature,key) in featureList" :key="feature.slug">
                <fieldset>
                <legend>{{makeLabel(feature.is_pro)}}</legend>
                    <div class="feature_inner">
                        <div class="feature-title">{{feature.title}}</div>
                        <div class="ha-dashboard-features__item-toggle ha-toggle">
                            <input :id="`ha-feature-${feature.slug}`" type="checkbox" :value="feature.slug" class="ha-toggle__check ha-feature" v-model="feature.is_active" @click="isFeatureActive(feature.slug,feature.is_active)">
    ...
    <ha-nav prev="widgets" next="bepro" @set-tab="setTab"></ha-nav>
</div>